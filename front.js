...
let genLastPokemon = ['Mew', 'Celebi', 'Deoxys', 'Arceus', 'Genesect', 'Volcanion', 'Melmetal', 'Enamorus'];
let genLastSprite = ['Mew', 'Celebi', 'Deoxys-speed', 'Arceus-Fairy', 'Genesect', 'Volcanion', 'Melmetal', 'Palkia-Origin'];
let genNames = ["0", "1", "2", "3", "4", "5", "6", "7", "8"]
