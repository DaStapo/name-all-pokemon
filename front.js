...
let genLastPokemon = ['Mew', 'Celebi', 'Deoxys', 'Arceus', 'Genesect', 'Volcanion', 'Melmetal', 'Enamorus', 'Miraidon'];
let genLastSprite = ['Mew', 'Celebi', 'Deoxys-speed', 'Arceus-Fairy', 'Genesect', 'Volcanion', 'Melmetal', 'Palkia-Origin', 'Miraidon'];
