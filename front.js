...
let language_map = {'ENG':en_pokemonList, 'FRE':fr_pokemonList, 'GER':de_pokemonList, 'KOR':ko_pokemonList, 'JPN': jp_pokemonList, 'ESP': es_pokemonList, 'ITA': it_pokemonList}
...
for (let key in language_map){
    ...
    if (key == 'ENG' || key == 'JPN' || key == 'KOR' || key == 'ESP' || key == 'ITA'){
        lang.click()
    }
